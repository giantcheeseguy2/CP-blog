...
const template2 = '</title> </head> <body style="margin:0;"> <div class="navbar"> <img src="../images/logo.jpg" class="logo"> <div class="title"><b>Oursaco</b> Blog</div> <button class="button" onclick="window.location.href=\'../index.html\'"><a href="../index.html">Home</a></button> <button class="button" onclick="window.location.href=\'../about.html\'"><a href="../about.html">About</a></button> <button class="button" onclick="window.location.href=\'../links.html\'"><a href="../links.html">Links</a></button> </div> <div style="width:100%;height:15%;"></div>\n<div class="blog">';
const template3 = '</div> </body> </html>';
...
fs.readdir(read, (err, files) => {
    ...
    files.forEach(file => {
        fs.readFile(read + file, 'utf8', (err, data) => {
            ...
            let value = template1 + title + template2 + writer.render(reader.parse(content)) + template3;
            ...
            let id = {
                "title": title,
                "dir": write1 + path.parse(file).name + '.html',
                "date": date,
                "tags": tags
            };
